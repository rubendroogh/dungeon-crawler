public partial class FrozenStatusEffectBehaviour : BaseStatusEffectBehaviour
{
    public override void ProcessEffectOnApply(Character target)
    {
        ...
        ManagerRepository.BattleLogManager.Log($"{target.Name} is frozen and takes double physical damage.");
    }
    ...
    public override void ProcessEffectOnRemove(Character target)
    {
        ...
        ManagerRepository.BattleLogManager.Log($"{target.Name} is no longer frozen and physical damage modifiers are removed.");
    }
}
